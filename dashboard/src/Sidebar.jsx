  ...
  return (
    <div className="space-y-4 text-sm">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2 rounded-lg border border-pantheon-border text-pantheon-muted hover:border-pantheon-accent/50 hover:text-pantheon-accent transition-colors text-xs"
      >
        <span>⚡</span> React to this gem
      </button>

      {feedbackOpen && <FeedbackModal gem={gem} onClose={() => setFeedbackOpen(false)} />}
